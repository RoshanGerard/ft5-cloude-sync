...
- [ ] 12.1 Use Superpowers `requesting-code-review` skill at the natural review checkpoints: after §3 (engine layer), after §6 (sync-service layer), after §10 (renderer layer)
- [ ] 12.2 Address critical issues before progressing to the next layer
