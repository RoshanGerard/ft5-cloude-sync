...
//     the child folders and `Contents` carries the child files. `FileEntry.handle`
 ...
 */
function mimeFamilyForKey(key: string): MimeFamily {
...
/** Build a base FileEntry from an S3 key + optional list/head fields. */
...
/** Build a folder FileEntry from a `CommonPrefixes` entry. */
